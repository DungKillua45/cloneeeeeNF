...
const signup = () => {
    ...
    // console.log('checkemail: ' + checkemail(emailElement.value))
    // console.log('checkusername: ' + checkusername(usernameElement.value))
    // console.log('checkpassword: ' + checkpassword(passwordElement.value))
    // console.log('checkrepassword: ' + checkrepassword(repasswordElement.value))
